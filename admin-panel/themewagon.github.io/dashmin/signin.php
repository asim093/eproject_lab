...
if (isset($_POST["signin"])) {
    ...
    if(isset($_POST['email']) && isset($_POST['password'])) {
        ...
        if(mysqli_num_rows($result) == 1) {
            ...
            $_SESSION['Admin-Name'] = $_POST['email']; 
            header('location: http://localhost/eproject/admin-panel/themewagon.github.io/dashmin/index.php');
            exit();
        } else {
            echo "<script> alert('Please provide correct email and password.') </script>";
        }
    } else {
        echo "<script> alert('Email and password not set in POST.') </script>";
    }
}
?>
...
<!-- Mirrored from themewagon.github.io/dashmin/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 12:43:51 GMT -->
<!-- Added by HTTrack -->
